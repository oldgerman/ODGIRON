...
//-----------------------------------------make_translation.py----------------------------------------------------------
//Symbol ASCII符号组，由Translation文件夹的make_translation.py完成，放在st源码里编译不好吗
...
//DebugMenu ASCII符号组，由Translation文件夹的make_translation.py完成，放在st源码里编译不好吗
extern const char *DebugMenu[];
#endif /* TRANSLATION_H_ */

//-------------------------------------------------么有的符号-----------------------------------------------------------
//这些字符串从translation_???_HK.json构建, 我从translation_en.json构建，注意translation_HK.json里有中文字符的
...
extern const char *SelfCheckIsOK;
