...
/**
 * 1<<6即向MEASURE寄存器写入001000000
 * bit 7: 保留 用0x80?来连续写人
 * bit 6: 0: MDAC测量CC* 由MEAS_CC位控制； 1: MDAC测量VBUS 要求MEAS_CC*位为0
 * bit 5:0 MDAC测量结果
 */
#define FUSB_MEASURE_MEAS_VBUS  (1 << 6)	// !
#define FUSB_MEASURE_MDAC_SHIFT 0
#define FUSB_MEASURE_MDAC       (0x3F << FUSB_MEASURE_MDAC_SHIFT)	//0011_1111
